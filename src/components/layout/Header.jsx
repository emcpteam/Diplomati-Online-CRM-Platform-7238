...
const Header = ({ setSidebarOpen }) => {
  ...
  const isAdmin = () => {
    return state.user && (state.user.role === 'Super Admin' || state.user.role === 'Admin');
  };
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <motion.div
                ...
                className="absolute right-0 top-12 w-80 bg-white rounded-xl shadow-strong border border-neutral-200 py-4 z-[9998]"
              >
            ...
            <AnimatePresence>
              {showSearch && (
                <motion.div
                  ...
                  className="absolute right-0 top-12 w-96 bg-white rounded-xl shadow-strong border border-neutral-200 z-[9998]"
                >
                  <div className="p-4">
                    <Input
            ...
            <AnimatePresence>
              {showUserMenu && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 top-12 w-64 bg-white rounded-xl shadow-strong border border-neutral-200 py-2 z-[10000]"
                >
                  ...
                  <div className="py-2">
                    ...
                    {/* Change Password - Only for Admin users */}
                    {isAdmin() && (
                      <button
                        onClick={() => {
                        ...
                        className="w-full flex items-center space-x-3 px-4 py-2 text-left hover:bg-neutral-50 transition-colors"
                      >
                        <SafeIcon icon={FiIcons.FiLock} className="w-4 h-4 text-neutral-500" />
                        <span className="text-sm text-neutral-700">Cambia Password</span>
                      </button>
                    )}
